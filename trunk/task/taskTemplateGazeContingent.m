...
myscreen.eyeTrackerType = 'Eyelink';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
myscreen.eyetracker.savedata = 0;
myscreen = initEyeTracker(myscreen);
myscreen = calibrateEyeTracker(myscreen);

% this should be moved into update task... ?
mglPrivateEyelinkStartRecording([0 0 1 1]);
