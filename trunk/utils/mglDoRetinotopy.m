...
paramsInfo = {...
    ...
    {'easyFixTask',0,'Setting this greater than 0 will make the fixation task easier by making the cross bigger and the timing slower','type=numeric','incdec=[-1 1]','minmax=[0 inf]'},...
