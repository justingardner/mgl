...
%
%        $Id$
%      usage: [ackTime, processedTime] = mglPoints2c(x, y, size, r, g, b, a, isRound, antialiasing)
%         by: Benjamin Heasly
%       date: 03/17/2022
...
% mglFlush
function [ackTime, processedTime] = mglPoints2c(x, y, size, r, g, b, a, isRound, antialiasing)
