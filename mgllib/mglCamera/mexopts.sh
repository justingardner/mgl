...
#
            ...
            LDFLAGS="$LDFLAGS -bundle -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -framework Cocoa -framework Carbon -framework openGL -rpath /Applications/Spinnaker/lib/ -L/Applications/Spinnaker/lib -lSpinnaker -lSpinnaker_C"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
