...
#----------------------------------------------------------------------------
            CC='gcc'
            CFLAGS='-x objective-c -fno-common -no-cpp-precomp -fexceptions -I/Applications/Spinnaker/include/spinc -I/usr/local/include/spinnaker/spinc'
            CLIBS="$MLIBS -lstdc++"
...
#
            LD="$CC"
            LDEXTENSION='.mexmac'
            LDFLAGS="-bundle -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -F$HOME/Library/Frameworks -framework agl -framework Carbon -framework Cocoa -framework CoreServices -rpath /Applications/Spinnaker/lib/ -L/Applications/Spinnaker/lib -lSpinnaker -lSpinnaker_C"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
...
#            CC='g++-3.3'
            CC='gcc-4.0'
            CFLAGS='-x objective-c -fno-common -no-cpp-precomp -fexceptions -arch i386 -I/Applications/Spinnaker/include/spinc -I/usr/local/include/spinnaker/spinc'
            CLIBS="$MLIBS -lstdc++"
            COPTIMFLAGS='-O3 -DNDEBUG'
            CDEBUGFLAGS='-g'
#
...
#
            LD="$CC"
            LDEXTENSION='.mexmaci'
            LDFLAGS="-bundle -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -F$HOME/Library/Frameworks -framework agl -framework Carbon -framework Cocoa -framework CoreServices -framework QTKit -rpath /Applications/Spinnaker/lib/ -L/Applications/Spinnaker/lib -lSpinnaker -lSpinnaker_C"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
...
#
            ...
            LDFLAGS="$LDFLAGS -bundle -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -framework Cocoa -framework Carbon -framework openGL -rpath /Applications/Spinnaker/lib/ -L/Applications/Spinnaker/lib -lSpinnaker -lSpinnaker_C -lSpinVideo"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
