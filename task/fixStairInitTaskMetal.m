...
%
function [task myscreen] = fixStairInitTaskMetal(myscreen)
...
if ~isfield(fixStimulus,'fixWidth') fixStimulus.fixWidth = 2; end
if ~isfield(fixStimulus,'fixLineWidth') fixStimulus.fixLineWidth = 0.2; end
...
% mglMetalArcs(fixStimulus.pos(1),fixStimulus.pos(2),fixStimulus.diskSize*[1 1],myscreen.background,60);
mglMetalArcs([fixStimulus.pos(1),fixStimulus.pos(2),0]',[0.5 0.5 0.5 1]',fixStimulus.diskSize*[0 1]',[0 2*pi]',0.1);

mglMetalFixationCross(fixStimulus.fixWidth,fixStimulus.fixLineWidth,fixStimulus.thisColor,fixStimulus.pos);
