...
#----------------------------------------------------------------------------
            CC='gcc'
            CFLAGS='-x objective-c -fno-common -no-cpp-precomp -fexceptions -I/Library/Frameworks/eyelink_core.framework/Headers -I/Developer/Library/Frameworks/eyelink_core.framework/Headers'
            CLIBS="$MLIBS -lstdc++"
...
#            CC='g++-3.3'
            CC='gcc-4.0'
            CFLAGS='-x objective-c -fno-common -no-cpp-precomp -fexceptions -arch i386 -pthread -I/Library/Frameworks/eyelink_core.framework/Headers -I/Developer/Library/Frameworks/eyelink_core.framework/Headers'
            CLIBS="$MLIBS -lstdc++"
            COPTIMFLAGS='-O3 -DNDEBUG'
            CDEBUGFLAGS='-g'
#
